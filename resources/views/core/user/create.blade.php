<x-core.layouts.app>
    <x-core.cards.app title="Tambah Pengguna">
        ...
        <x-core.forms.app action="{{ route('core.users.store') }}" method="POST">
            <div class="flex flex-col gap-4">
                <x-core.inputs.group>
                    ...
                    <x-core.inputs.text id="input_name" name="name" value="{{ old('name') }}"
                ...
                <x-core.inputs.group>
                    ...
                    <x-core.inputs.email id="input_email" name="email" value="{{ old('email') }}"
                ...
                <x-core.inputs.group>
                    ...
                    <x-core.inputs.tel id="input_phone" name="phone" value="{{ old('phone') }}"
                ...
                <x-core.inputs.group>
                    ...
                    <x-core.inputs.password id="input_password_confirmation" name="password_confirmation"
                        placeholder="Masukkan Konfirmasi Password" required="true" autocomplete="new-password" />
                ...
                <x-core.inputs.group>
                    ...
                    <x-core.inputs.select id="input_role" name="role" required="true" value="{{ old('role') }}"
                        :options="$roles" optionPlaceholder="-- Pilih Role --">
